...
/**
 * Class Gravity_Extract_GitHub_Updater
 *
...
class Gravity_Extract_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'gravity-extract';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'gravity-extract/gravity-extract.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'gravity-extract';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Gravity Extract';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Adds a new upload field to Gravity Forms that uses AI to extract invoice information from images.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'gravity-extract';
     ...
     * @var string
     */
    private const CACHE_KEY = 'gravity_extract_github_release';
...
// Initialize the updater
Gravity_Extract_GitHub_Updater::init();
